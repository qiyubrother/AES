...
namespace qiyubrother
{
    ...
    public class AES
    {
        ...
        public static byte[] Encrypt(string text, string password) => Encrypt(Encoding.UTF8.GetBytes(text), Encoding.ASCII.GetBytes(password));

        /// <summary>
        /// AES 加密
        /// </summary>
        /// <param name="originalBytes">原文</param>
        /// <param name="passwordBytes">密钥</param>
        /// <returns>返回密文</returns>
        public static byte[] Encrypt(byte[] originalBytes, byte[] passwordBytes)
        {
        ...
        public static byte[] Decrypt(string decryptedText, string password) => Decrypt(Encoding.UTF8.GetBytes(decryptedText), Encoding.ASCII.GetBytes(password));
        /// <summary>
        /// AES 解密
        /// </summary>
        /// <param name="decryptedText">密文</param>
